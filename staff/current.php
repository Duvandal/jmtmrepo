    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #001f44;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="current.php">Current Issue <span class="sr-only">(current)</span></a>
                </li>
            </ul>
                    ...
                    <div class="span9 mx-auto">
                        ...
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from repo.record,repo.buku where Username = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and buku.KodePelaksana = record.KodePelaksana and (record.KodePelaksana='$s' or Perihal like '%$s%')";

                                        }
                                    else
                                        $sql="select * from repo.record,repo.buku where Username = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and buku.KodePelaksana = record.KodePelaksana";
