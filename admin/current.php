                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Masukkan Nama Peminjam/Uraian/Kode Pelaksana." class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select record.KodePelaksana,Username,Perihal,Due_Date,Date_of_Issue,datediff(curdate(),Due_Date) as x from repo.record,repo.buku 
                                            where (Date_of_Issue is NOT NULL and Date_of_Return is NULL and buku.KodePelaksana = record.KodePelaksana) 
                                            and (Username='$s' or record.KodePelaksana='$s' or Perihal like '%$s%')";
                                        }
                                    else
                                        $sql="select record.KodePelaksana,Username,Perihal,Due_Date,Date_of_Issue,datediff(curdate(),Due_Date) as x 
                                        from repo.record,repo.buku where Date_of_Issue is NOT NULL and Date_of_Return is NULL and buku.KodePelaksana = record.KodePelaksana";
